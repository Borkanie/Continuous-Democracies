...
func seedDatabase(ctx context.Context, database *mongodriver.Database) error {
	fixtures := []struct {
		...
		{db.ColParties, "../fixtures/parties.json"},
		{db.ColPoliticians, "../fixtures/politicians.json"},
		{db.ColVotingRounds, "../fixtures/voting_rounds.json"},
		{db.ColVotes, "../fixtures/votes.json"},
	}
